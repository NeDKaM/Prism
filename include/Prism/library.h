...
PR_CPP_PROTECT_ON
    ...
    PR_STRUCT(pr_library_t, Pr_Library);
    ...
    extern PRISM_API int            Pr_ClassRegistered(Pr_LibraryRef, char const *);
    extern PRISM_API int            Pr_ImportLibrary(Pr_LibraryRef, Pr_Library *);

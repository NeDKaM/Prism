...
PR_CPP_PROTECT_ON
    ...
    extern PRISM_API int                Pr_PushFrontList(Pr_List *);
    extern PRISM_API void               Pr_PopFrontList(Pr_List *);
    extern PRISM_API unsigned int       Pr_ListSize(Pr_ListRef);
    extern PRISM_API int                Pr_PushBackList(Pr_List *);
    extern PRISM_API void               Pr_PopBackList(Pr_List *);
    extern PRISM_API void *             Pr_ListAt(Pr_ListRef, unsigned int);
    extern PRISM_API void *             Pr_FrontList(Pr_ListRef);
    extern PRISM_API void *             Pr_BackList(Pr_ListRef);
    extern PRISM_API void               Pr_PopListAt(Pr_List *, unsigned int);
    extern PRISM_API int                Pr_InsertList(Pr_List *, unsigned int);
    extern PRISM_API int                Pr_SetListDataAt(Pr_List *, unsigned int, void *);
    extern PRISM_API int                Pr_GetListDataPosition(Pr_ListRef, void *);
    extern PRISM_API int                Pr_PushBackListData(Pr_List *, void *);
